...
class BeerFavoriteListFragment : Fragment() {

    companion object {
        fun newInstance() = BeerFavoriteListFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.beer_favorite_list_fragment, container, false)
    }
